            ...
            <form action="{{ route('contents.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                        <input value="{{ old('title') }}" type="text" name="title" class="form-control" placeholder="Enter Title" required>
                    </div>
                </div><!-- row -->
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                        <select name="type" class="form-control">
                            ...
                            <option @if(old('type') == 'blog') selected @endif value="blog">Blog</option>
                        </select>
                    </div>
                </div><!-- row -->
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                        <textarea name="content" class="form-control summernote_editor">{{ old('content') }}</textarea>
                    </div>
                </div><!-- row -->
